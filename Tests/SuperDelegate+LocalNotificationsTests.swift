...
class SuperDelegateLocalNotificationTests: SuperDelegateTests {
    ...
    func test_applicationDidFinishLaunching_loadsInterfaceWithLaunchItem() {
        ...
        XCTAssertTrue(localNotificationCapableDelegate.application(UIApplication.shared(), didFinishLaunchingWithOptions: [UIApplicationLaunchOptionsLocalNotificationKey : localNotification]))
