...
class SuperDelegateTests: XCTestCase {
    ...
    func test_applicationWillFinishLaunching_notesImproperAPIUsageAndReturnsFalseWhenUnsupportedLaunchOptionUserActivityPresent() {
        ...
        XCTAssertFalse(appLaunchedDelegate.application(UIApplication.shared(), willFinishLaunchingWithOptions: [UIApplicationLaunchOptionsUserActivityDictionaryKey : [ApplicationLaunchOptionsUserActivityKey : NSUserActivity(activityType: "a type")]]))
    ...
    func test_applicationWillFinishLaunching_notesImproperAPIUsageAndReturnsTrueWhenUnsupportedLaunchOptionShortcutItemPresent() {
        ...
        XCTAssertTrue(appLaunchedDelegate.application(UIApplication.shared(), willFinishLaunchingWithOptions: [UIApplicationLaunchOptionsShortcutItemKey : UIApplicationShortcutItem(type: "A type", localizedTitle: "A title")]))
        XCTAssertFalse(appLaunchedDelegate.expectImproperAPIUsage)
        XCTAssertEqual(appLaunchedDelegate.launchItem, LaunchItem.none)
    }
    ...
    func test_applicationWillFinishLaunching_notesImproperAPIUsageAndReturnsFalseWhenUnsupportedLaunchOptionURLPresent() {
        ...
        XCTAssertFalse(appLaunchedDelegate.application(UIApplication.shared(), willFinishLaunchingWithOptions: [UIApplicationLaunchOptionsURLKey : NSURL(fileURLWithPath: "/")]))
        XCTAssertFalse(appLaunchedDelegate.expectImproperAPIUsage)
        XCTAssertEqual(appLaunchedDelegate.launchItem, LaunchItem.none)
    }
