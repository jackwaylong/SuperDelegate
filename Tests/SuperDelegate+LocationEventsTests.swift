...
class SuperDelegateLocationEventsTests: SuperDelegateTests {
    ...
    func test_applicationDidFinishLaunching_notifiesAboutLocationEvent() {
        ...
        XCTAssertTrue(locationEventsCapableDelegate.application(UIApplication.shared(), didFinishLaunchingWithOptions: [UIApplicationLaunchOptionsLocationKey : true]))
    ...
    func test_applicationWillFinishLaunching_doesNotNotifyAboutLocationEvent() {
        let locationEventsCapableDelegate = LocationEventsCapableDelegate()
        XCTAssertTrue(locationEventsCapableDelegate.application(UIApplication.shared(), willFinishLaunchingWithOptions: [UIApplicationLaunchOptionsLocationKey : true]))
